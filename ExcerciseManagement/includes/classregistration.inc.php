<?php
    ...
    if(isset($_POST['submit-registration'])) {
        ...
        $sql = "INSERT INTO class_registration (Exercise_Number, Member_Number, Building, Room_Number, InstructorID, Class_Date, Class_Start_Time, Class_Reg_Date, Guests  )
                    VALUES ('$excercisenumber', '$membernumber', '$building', '$roomnumber', '$instructorid', '$classdate', '$classstarttime', '$classregistrationdate', '$guest')";
